...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_edit_profile__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_edit_password__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_notification__ = __webpack_require__(97);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_0_vuex__["a" /* default */].Store({
    modules: {
        ...
        EditProfile: __WEBPACK_IMPORTED_MODULE_3__modules_edit_profile__["a" /* default */],
        EditPassword: __WEBPACK_IMPORTED_MODULE_4__modules_edit_password__["a" /* default */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_App__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_passport__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__locale_VeeValidate_zh_CN__ = __webpack_require__(89);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    mutations: (_mutations = {}, _defineProperty(_mutations, __WEBPACK_IMPORTED_MODULE_1__mutation_type__["b" /* SET_AUTH_USER */], function (state, payload) {
        state.authenticated = true;
        state.name = payload.user.name;
        state.email = payload.user.email;
    }), _defineProperty(_mutations, __WEBPACK_IMPORTED_MODULE_1__mutation_type__["d" /* UNSET_AUTH_USER */], function (state) {
    ...
    actions: {
        setAuthUser: function setAuthUser(_ref) {
            ...
            return axios.get('/api/user').then(function (response) {
                commit({
                    type: __WEBPACK_IMPORTED_MODULE_1__mutation_type__["b" /* SET_AUTH_USER */],
                    user: response.data
                });
            }).catch(function () {
        ...
        unsetAuthUser: function unsetAuthUser(_ref3) {
            ...
            commit({
                type: __WEBPACK_IMPORTED_MODULE_1__mutation_type__["d" /* UNSET_AUTH_USER */]
            });
        },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_passport__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_router__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_index__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_passport__ = __webpack_require__(4);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__EditProfileForm__ = __webpack_require__(65);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        updateProfile: function updateProfile() {
            ...
            this.$store.dispatch('updateProfileRequest', formData).then(function (res) {
                _this.$router.push({ name: 'profile' });
            }).catch(function (error) {});
        }
    }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__EditPasswordForm__ = __webpack_require__(75);
        ...
        updatePassword: function updatePassword() {
            ...
            this.$validator.validateAll().then(function (result) {
                if (result) {
                    ...
                    _this.$store.dispatch('updatePasswordRequest', formData).then(function (res) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_TopMenu__ = __webpack_require__(85);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_Notification__ = __webpack_require__(98);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    created: function created() {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2__helpers_passport__["a" /* default */].getToken()) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mutation_type__ = __webpack_require__(14);
var _mutations;
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    }), _defineProperty(_mutations, __WEBPACK_IMPORTED_MODULE_0__mutation_type__["a" /* HIDE_NOTIFICATION */], function (state) {
        state.level = 'success';
        state.message = null;
    }), _mutations),
    actions: {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("503a5bf6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-65229430\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Notification.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-65229430\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Notification.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: "notification",
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["c" /* mapState */])('Notification', ['level', 'message']), {
        notificationLevel: function notificationLevel() {
            return 'alert-' + this.level;
        }
    }),
    methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["b" /* mapActions */])('Notification', ['hideNotification']))
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c(
      ...
      [
        _c("transition", { attrs: { mode: "in-out", name: "fade" } }, [
          _vm.message
            ? _c(
                "div",
                {
